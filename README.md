...
3. Abra **[http://localhost/install.php](http://localhost/install.php)** e clique no link `here` exibido na página.
![Instalação do bWAPP](assets/001-bwap-install.png "Instalação do bWAPP")

4. Vá para **[http://localhost/login.php](http://localhost/login.php)**
